...
procedure compressstream(var instream:Tmemorystream);overload;
procedure CompressSteam(inStream,outStream:TMemoryStream);overload;
procedure decompressstream(var instream:Tmemorystream);overload;
procedure DecompressStream(inStream,outStream:TmemoryStream);overload;
implementation
procedure DecompressStream(inStream,outStream:TmemoryStream);overload;
var
...
begin
   ...
   outStream.Clear;
   outStream.SetSize(size);
   zstream:=Tdecompressionstream.Create(instream);
   try
      zstream.Readbuffer(outStream.memory^,size);
...
procedure decompressstream(var instream:Tmemorystream);overload;
var zstream:Tdecompressionstream;
