...
begin
  ...
  case gw of
  0:result:=result+'0';1:result:=result+'1';2:result:=result+'2';3:result:=result+'3';
  4:result:=result+'4';5:result:=result+'5';6:result:=result+'6';7:result:=result+'7';
  8:result:=result+'8';9:result:=result+'9';10:result:=result+'A';11:result:=result+'B';
  12:result:=result+'C';13:result:=result+'D';14:result:=result+'E';15:result:=result+'F';
  end;
end;
...
var
 ...
 I, J: Integer;
begin
 if (Length(Str) > 0) and (Ord(Str[Length(Str)]) = 0) then exit;
...
begin
 ...
 begin
   ...
   Temp:=ByteToHex(Ord(TempResult[I + 1]));
